...
#######################
# Load Balancer + Target Group + Listeners
#######################
resource "aws_lb" "alb" {
  name               = "ecs-demo-alb"
...
# Optional HTTPS listener (only created when enable_https = true)
